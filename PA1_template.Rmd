...
The time interval with the highest total number of steps occurs at `r t$hour`:`r t$min`, and that a total of `r y` steps were taken during that time interval over the observed period.
