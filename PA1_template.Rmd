...
The time interval with the highest total number of steps occurs at `r t$hour`:`r t$min`, and that `r y` steps were taken in total during that time interval over the observed period.
